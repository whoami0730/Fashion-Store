...
<body>
    ...
    @section('main')
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-muted">Get up to <span class="h1 text-danger">30%</span> Off</h4>
                        <h1 class="mb-5 display-3 text-primary">Select Your New Perfect Style</h1>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="assets1/img/hero-img-1.png" class="img-fluid w-100 h-100 bg-secondary rounded"
                                        alt="First slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="assets1/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                        alt="Second slide">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="featurs-item text-center rounded bg-light p-4">
                            ...
                            <div class="featurs-content text-center">
                                <h5>Free Shipping</h5>
                                <p class="mb-0">Free on order over ₹ 499</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
        ...
        <div class="container-fluid vesitable pt-5">
            <div class="container py-5">
                <h1 class="mb-0">Select Category</h1>
                <div class="owl-carousel vegetable-carousel justify-content-center mt-3">
                            ...
                            <div class="vesitable-img">
                                <a href="{{ route('productbycategory', $category->category_id) }}">
                                    <img src="{{ asset('/storage/CategoryImage/' . $category->image) }}"
                                        class="img-fluid w-100 rounded-top" alt="Category Image">
                                </a>
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                style="top: 10px; right: 10px;">{{ $category->category_name }}</div>
                        </div>
                    @endforeach
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-9 text-center">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                @foreach ($productByCategory as $CategoryName => $products)
                                    <li class="nav-item">
                                        <a class="d-flex m-2 py-2 bg-light rounded-pill {{ $loop->first ? 'active' : '' }}"
                                            data-bs-toggle="pill" href="#{{ Str::slug($CategoryName) }}">
                                            <span class="text-dark" style="width: 130px;">{{ $CategoryName }}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                                            ...
                                            @foreach ($products as $product)
                                                <div class="col-md-6 col-lg-4 col-xl-3 ">
                                                    <div
                                                        ...
                                                        <div class="p-4">
                                                            <h5 class="h5">{{ $product->product_name }}</h5>
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-6">
                        {{-- <div class="position-relative">
                            <img src="assets1/img/baner-1.png" class="img-fluid w-100 rounded" alt="">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="bg-secondary rounded">
                                    <img src="assets1/img/testimonial-1.jpg" class="img-fluid rounded"
