...
<head>
    <meta charset="utf-8">
    <title>Fashion Store | Add Address Page</title>
...
<body>
    ...
    @section('main')
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Add Address</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                <li class="breadcrumb-item active text-white">Add New Address</li>
            </ol>
        </div>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="row g-5">
                    <div class="col-md-12 ">
                        <form action="{{ route('new_address') }}" method="post">@csrf
                            <div class="row">
